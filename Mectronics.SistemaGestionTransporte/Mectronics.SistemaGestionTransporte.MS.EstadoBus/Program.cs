...
builder.Services.AddScoped<IEstadoBusServicio, EstadoBusServicio>();
builder.Services.AddScoped<IEstadoBusRepositorio, EstadoBusRepositorio>();
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "API de EstadoBus",
        Version = "v1",
        Description = "API para la gestión de Estado de Buses en el sistema de gestion de transporte.",
