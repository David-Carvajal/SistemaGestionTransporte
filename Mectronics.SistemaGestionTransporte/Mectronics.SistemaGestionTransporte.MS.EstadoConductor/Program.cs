...
builder.Services.AddScoped<IEstadoConductorServicio, EstadoConductorServicio>();
builder.Services.AddScoped<IEstadoConductorRepositorio, EstadoConductorRepositorio>();
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "API de EstadoConductor",
        Version = "v1",
        Description = "API para la gestión de estado de conductores en el sistema de gestion de transporte.",
